...
; Certification-only ARM64 migration installer for persistent Windows 11 ARM64 validation.
; The canonical production installer is intentionally unchanged.
...
OutputBaseFilename=BKE-Licensing-Agent-{#AppVersion}-RuntimeBridge-Windows-arm64
