...
class LicensingPlatformClient:
    ...
    def activate_platform_lease(self, request: PlatformLeaseActivationRequest) -> PlatformLeaseResponse:
        ...
        return self._request("POST", ACTIVATE, PlatformLeaseResponse, request.model_dump(by_alias=True, exclude_none=True), idempotent=True, protocol_version="bke.licensing.v3")
